...
class HomePageRide extends StatefulWidget {
  const HomePageRide({super.key});

  @override
  State<HomePageRide> createState() => _HomePageRideState();
}

class _HomePageRideState extends State<HomePageRide> {
                  ...
                  Expanded(
                    child: ListTile(
                      ...
                      trailing: const Image(
                        image: AssetImage("images/topuser.png"),
                        height: 40,
                        width: 40,
                      ),
                    ),
            ...
            Column(
              children: [
                Container(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsets.only(left: 20, top: 21, bottom: 21),
                    child: Row(
                      children: [
                        Column(
