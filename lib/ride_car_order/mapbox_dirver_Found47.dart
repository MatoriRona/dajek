...
import 'package:dajek/ride_car_order/mapbox_driver_pickup48.dart';
...
class MapboxDriverFound47 extends StatefulWidget {
  const MapboxDriverFound47({Key? key});

  @override
  State<MapboxDriverFound47> createState() => _MapboxDriverFound47State();
}

class _MapboxDriverFound47State extends State<MapboxDriverFound47> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GestureDetector(
        child: GoogleMap(
          onTap: (argument) {
            Navigator.push(context, MaterialPageRoute(builder: (context) => const MapboxDriverPickup48(),)) ;
          },
