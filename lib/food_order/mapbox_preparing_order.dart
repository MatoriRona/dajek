...
import 'package:dajek/food_order/mapbox_delivering_order50.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';

class MapboxPreparingOrder49 extends StatefulWidget {
  const MapboxPreparingOrder49({super.key});

  @override
  State<MapboxPreparingOrder49> createState() => _MapboxPreparingOrder49State();
}

class _MapboxPreparingOrder49State extends State<MapboxPreparingOrder49> {
  ...
  Widget build(BuildContext context) {
    Timer(const Duration(seconds: 5), () {
      Navigator.push(context, MaterialPageRoute(builder: (context) => const MapboxDeliveringOrder50(),));
     });
    return Scaffold(
      body: GoogleMap(
